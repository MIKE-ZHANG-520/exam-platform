...
{
  "regulations": ["涉及的法规/规范名称，如 '《建筑法》'、'JGJ80-2016 建筑施工高处作业安全技术规范'"],
  "clauses": ["涉及的具体条款编号，如 'JGJ80-2016 第4.1.5条'、'《安全生产法》第41条'"],
  "risk_level": "high" | "medium" | "low",
...
若某项无法从材料中识别，用空数组或 "medium" 作默认值。仅使用材料中出现或明显暗示的信息，禁止编造。`;
