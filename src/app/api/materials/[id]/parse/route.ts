...
{
  "regulations": ["涉及的法规/规范名称，格式必须为 '编号-年份《名称》'，年份和编号必须严格来自上文【现行有效 法规/标准 白名单】。示例：'JGJ 80-2016《建筑施工高处作业安全技术规范》'、'JGJ 46-2024《施工现场临时用电安全技术标准》'。严禁使用列表外或已废止版本（如 JGJ46-2005）"],
  "clauses": ["涉及的具体条款编号，如 'JGJ 80-2016 第4.1.5条'、'《安全生产法》第41条'。编号和年份同样必须来自白名单"],
  "risk_level": "high" | "medium" | "low",
...
若某项无法从材料中识别，用空数组或 "medium" 作默认值。仅使用材料中出现或明显暗示的信息，禁止编造。所有法规/条款引用必须来自 SAFETY_EXPERT_ROLE 中的现行有效白名单。`;
